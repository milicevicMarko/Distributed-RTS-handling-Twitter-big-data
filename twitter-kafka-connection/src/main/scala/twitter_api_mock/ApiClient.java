...
public class ApiClient {
    ...
    private boolean isBearerTokenDefined = true;
    private boolean isOAUth2AccessTokenDefined = true;
    ...
    public ApiClient() {
        ...
        authentications.put("OAuth2UserToken", new OAuth("http://localhost:8085/2", "/oauth2/token"));
