...
import twitter_api_mock.TweetsApi;
...
public class TwitterApi {
    ...
    private void init() {
        String basePath = System.getenv("TWITTER_MOCK_SERVER");

        localVarApiClient.setBasePath(basePath != null ? basePath : "http://host.docker.internal:8085");
        new SDKConfig();
        initApis();
    }
